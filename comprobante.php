...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!$compra || $compra['estado'] !== 'activo') throw new RuntimeException('La compra ya no está activa.');
        if (!empty($compra['comprobante_nombre'])) throw new RuntimeException('Ya tiene comprobante.');
        ...
        flash('success', 'Comprobante recibido. Tus cupos quedan reservados hasta la validación.');
        redirect('index.php');
        ...
        <div class="glass p-3">
            ...
            <?php else: ?>
                <form method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-primary btn-lg btn-block mt-3" type="submit">Subir Comprobante</button>
                </form>
            <?php endif; ?>
        </div>
    </div>
