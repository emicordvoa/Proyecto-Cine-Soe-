...
$phoneCountries = [
    ...
    '58' => 'Venezuela +58','52' => 'Mexico +52','1' => 'EE.UU./Canada +1','34' => 'EspaÃ±a +34',
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (!verify_csrf($_POST['csrf'] ?? null)) {
            throw new RuntimeException('SesiÃ³n expirada. Intenta nuevamente.');
        }
        ...
        if (!$idPelicula || !$cantidad || !is_full_name($nombre) || !$correo || !isset($phoneCountries[$telefonoPais]) || strlen($telefonoLocal) < 5 || strlen($telefonoLocal) > 15) {
            throw new RuntimeException('Completa todos los datos con formatos vÃ¡lidos.');
        }
        $vendedor = null;
        if ($codigoVendedor !== '') {
            $vendedor = Compra::buscarVendedorPorRef($codigoVendedor);
            if (!$vendedor) throw new RuntimeException('El cÃ³digo de Staff SOE no existe.');
        }
...
<head>
    ...
    <title>Comprar entradas â€” Cine SOE</title>
...
<nav class="navbar" id="mainNav">
    ...
    <div class="nav-links"><a class="btn btn-ghost" href="index.php">â† Cartelera</a></div>
</nav>

<main class="checkout-page">
<div class="container">
    <a href="index.php" class="checkout-back">â† Volver a cartelera</a>

    <div class="glass checkout-panel">
        <p class="section-eyebrow">Compra segura</p>
        <h1>Reserva tus entradas</h1>
        <p class="text-muted text-sm mb-3">Tienes 10 minutos para subir el comprobante despuÃ©s de reservar.</p>
        ...
        <!-- Stepper -->
        <ol class="stepper">
            <li class="stepper-item active"><span class="stepper-num">1</span><span class="stepper-label">PelÃ­cula</span></li>
        ...
        <form method="post" data-stepper-form>
            ...
            <!-- Step 1: PelÃ­cula y cantidad -->
            <div class="step-panel active">
                <div class="form-row form-row-2 mb-3">
                    <div class="form-group">
                        <label class="form-label">PelÃ­cula</label>
                        <select class="form-input form-select" name="id_pelicula" id="movieSelect" required>
                            <?php foreach ($peliculas as $pelicula): ?>
                                <option value="<?= (int) $pelicula['id'] ?>"
                                    ...
                                    <?= e($pelicula['titulo']) ?> â€” <?= e(date('d/m', strtotime($pelicula['fecha_funcion']))) ?> <?= e(substr($pelicula['hora_funcion'], 0, 5)) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="qty-control">
                            <button type="button" class="qty-btn" data-qty="-1">âˆ’</button>
                ...
                <button type="button" class="btn btn-primary btn-lg btn-block" data-step-next>Siguiente â†’</button>
            </div>
            ...
            <div class="step-panel">
                ...
                <div class="form-row form-row-2 mb-3">
                    ...
                    <div class="form-group">
                        <label class="form-label">CÃ³digo Staff SOE (opcional)</label>
                ...
                <div class="flex gap-2">
                    <button type="button" class="btn btn-ghost btn-lg" data-step-prev>â† AtrÃ¡s</button>
                    <button type="button" class="btn btn-primary btn-lg" style="flex:1" data-step-next>Siguiente â†’</button>
                </div>
            </div>
            ...
            <div class="step-panel">
                ...
                <div class="flex gap-2">
                    <button type="button" class="btn btn-ghost btn-lg" data-step-prev>â† AtrÃ¡s</button>
                    <button class="btn btn-primary btn-lg" style="flex:1" type="submit">âœ“ Confirmar Compra</button>
                </div>
            </div>
        </form>
    </div>
